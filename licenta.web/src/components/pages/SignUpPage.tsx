...
export default function SignUpPage() {
  ...
  return (
      <div style={{position:"absolute",bottom:"50%",left:"50%",transform:"translate(-50%,50%)"}}> 
        <Card style={{display: "inline-grid",border:"2px solid"}} variant="outlined">
          <CardContent style={{ textAlign: "center",display: "inline-grid"}}>
            ...
            <div style={{ display:"grid",marginTop:"20px",marginLeft:"120px",marginRight:"120px",justifyContent:"center"}}>
              <Button type="button" color="primary"  variant="contained" size="medium" style={{width:160}}
                onClick={handleSignUp}> Create account
              </Button>
              <Button type="button" color="secondary"  variant="contained" size="large" style={{marginTop:"10px",width:160}}
